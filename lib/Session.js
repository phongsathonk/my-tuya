...
module.exports = class Session {
   ...
   _createClient() {
    ...
    _createToken() {
        requestUtil.post(Object.assign(this._options, {
   ...
   _refreshToken() {
    ...
    checkResponse(response, message = null) {
        ...
        if ( typeof response['responseStatus'] !== 'undefined' && response['responseStatus'] === 'error' ) {
            message = typeof response['errorMsg'] !== 'undefined' ? response['errorMsg'] : message;
